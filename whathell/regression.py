...
# load data
train = pd.read_csv('../output/cwsv_train.csv')
predict = pd.read_csv('../output/cwsv_predict.csv')
...
print("output to csv...")
train.to_csv('../output/cwsvr_train.csv',float_format='%.6f', index=False)
predict.to_csv('../output/cwsvr_predict.csv',float_format='%.6f', index=False)
