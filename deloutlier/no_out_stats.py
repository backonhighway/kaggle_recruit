...
print("output to csv...")
train.to_csv('../output/outlier_w5_cwrrs_train.csv',float_format='%.6f', index=False)
predict.to_csv('../output/outlier_w5_cwrrs_predict.csv',float_format='%.6f', index=False)
