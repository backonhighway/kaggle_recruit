...
# load data
train = pd.read_csv('../output/outlier_cwr_train.csv')
predict = pd.read_csv('../output/outlier_cwr_predict.csv')
...
print("output to csv...")
train.to_csv('../output/outlier_cwrr_train.csv',float_format='%.6f', index=False)
predict.to_csv('../output/outlier_cwrr_predict.csv',float_format='%.6f', index=False)
