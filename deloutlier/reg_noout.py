...
train = train[(~train["is_outlier17"]) | (train["visit_date"] >= "2017-03-01")]
print("loaded data.")
...
print("output to csv...")
train.to_csv('../output/outlier_cwr_train.csv',float_format='%.6f', index=False)
predict.to_csv('../output/outlier_cwr_predict.csv',float_format='%.6f', index=False)
