...
predict = pd.read_csv('../output/all_c_predict.csv')
...
train.to_csv('../output/all_cw_train.csv', float_format='%.6f', index=False)
predict.to_csv('../output/all_cw_predict.csv', float_format='%.6f', index=False)